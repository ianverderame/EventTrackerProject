...
INSERT INTO `route` (`id`, `name`, `city`, `state`, `length`, `picture_url`, `enabled`) VALUES (4, 'Colfax Marathon', 'Denver', 'Colorado', 26.2, 'https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2674&q=80', 1);
INSERT INTO `route` (`id`, `name`, `city`, `state`, `length`, `picture_url`, `enabled`) VALUES (5, 'Colfax Half Marathon', 'Denver', 'Colorado', 13.1, 'https://images.unsplash.com/photo-1551927336-09d50efd69cd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1752&q=80', 1);
...
INSERT INTO `run` (`id`, `rating`, `weather`, `date`, `heart_rate`, `time`, `completed`, `picture_url`, `route_id`) VALUES (3, 3, 'Overcast', '2021-12-28', 167, 7.56, 1, 'https://media.istockphoto.com/photos/fit-black-sporty-man-training-in-the-city-picture-id1295949061', 1);
...
INSERT INTO `run` (`id`, `rating`, `weather`, `date`, `heart_rate`, `time`, `completed`, `picture_url`, `route_id`) VALUES (7, 1, 'Rainy', '2018-4-16', 173, 204, 1, 'https://images.unsplash.com/photo-1553593155-9e0dc045405c?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2670&q=80', 6);
